...
<body>
	...
	<div class="container" style="margin-top:20px">
		...
		if(isset($_POST['submit'])){
			...
			$sql = mysqli_query($koneksi, "UPDATE dosen SET id='$id', mata_kuliah='$mata_kuliah', nama='$nama', hari='$hari', semester='$semester'  WHERE id='$id'") or die(mysqli_error($koneksi));
			
			if($sql){
				echo '<script>alert("Berhasil menyimpan data."); document.location="edit dosen.php?id='.$id.'";</script>';
			}else{
		...
		<form action="edit dosen.php?id=<?php echo $id; ?>" method="post">
			<div class="form-group row">
				<label class="col-sm-2 col-form-label">ID</label>
				<div class="col-sm-10">
					<input type="text" name="id" class="form-control" value="<?php echo $data['id']; ?>" required>
				</div>
			</div>
			<div class="form-group row">
